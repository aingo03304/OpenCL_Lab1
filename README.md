...
# Lab assignment 1 - OpenCL Vector Addition
...
The following will compile the template file that you will modify to implement vector addition in OpenCL, and the data generator that will generate input files. 
